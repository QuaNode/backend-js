    ...
    switch (type) {
        case Number:
            try {
                ...
                if (typeof value === 'string') value = value.indexOf('.') > -1 ? parseFloat(value) :
                    parseInt(value);
...
var getServiceValue = function (serviceObject, attributeMetadata, modelAttributes, key, value) {
    ...
    if (typeof attributeMetadata.getValue === 'function')
        return getParsedValue(attributeMetadata.getValue(serviceObject), modelAttributes &&
...
module.exports.ServiceObjectMapping.prototype.mapServiceObject = function (serviceObject, objectMetadata,
    modelAttributes, modelObjects, cb) {
...
module.exports.ServiceObjectMapping.prototype.getIDServiceValue = function (serviceObject,
    objectMetadata, modelAttributes) {
