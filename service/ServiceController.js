                ...
                var next = function () {
                    ...
                    if (modelEntity && (index % 1000 === 0 || index === serviceObjects.length - 1)) {
                        ...
                        if (typeof save === 'function') save(function () {
                            ...
                            if (index + 1 < serviceObjects.length) queryByID(index + 1, serviceObjects,
...
var queryByID = function (index, serviceObjects, objectMetadata, callback, options, serviceObjectMapping,
    modelEntity) {
        ...
        if (idServiceValue) {
            ...
            if (typeof getObjectsByID === 'function')
                getObjectsByID(objectMetadata.id, idServiceValue, modelEntity,
                    getQueryByIDCallback(index, serviceObjects, objectMetadata, callback, options,
                        serviceObjectMapping, modelEntity));
